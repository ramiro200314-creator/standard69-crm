...
/* P1 cover */.p1{display:flex;flex-direction:column;align-items:center;padding:22px 40px 44px}.p1-logo{margin-bottom:2px;text-align:center}.p1-logo img{height:38px;display:block;margin:0 auto}.p1-img{width:100%;height:210px;border-radius:3px;overflow:hidden;margin:18px 0 8px}.p1-img img{width:100%;height:100%;object-fit:cover;display:block}.p1-sub{display:flex;gap:8px;width:100%;margin-bottom:8px}.p1-sub-img{flex:1;height:112px;border-radius:3px;overflow:hidden}.p1-sub-img img{width:100%;height:100%;object-fit:cover;display:block}
